...
namespace MookEditor.Utils.Localization
{
    [MarkupExtensionReturnType(typeof(BindingExpression))]
    class LocalizedLangExtension : MarkupExtension, INotifyPropertyChanged
    {
        ...
        {
            // 本地化语言资源文件根名
            ResourceManager = new ResourceManager("MookEditor.Resources.I18n.I18n", typeof(LocalizedLangExtension).Assembly);
